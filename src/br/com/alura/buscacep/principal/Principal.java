...
public class Principal {
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            System.out.println(gson.fromJson(response.body(), EnderecoViaCep.class));
            //String jsonCorrigido = gson.fromJson(response.body().toString(), String.class);
            EnderecoViaCep enderecoViaCep = gson.fromJson(response.body(), EnderecoViaCep.class);
            System.out.println(enderecoViaCep.cep());
